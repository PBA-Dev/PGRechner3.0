    ...
    "questions": [
        {
            ...
            "options": [
                {"score": 0, "text": "Nie oder selten", "option_explanation": "Verhalten tritt praktisch nicht auf."},
                {"score": 1, "text": "Selten (1-3 Mal innerhalb von zwei Wochen)", "option_explanation": "Verhalten tritt gelegentlich auf."},
                {"score": 3, "text": "Häufig (Zweimmal bis mehrmals wöchentlich aber nicht täglich)", "option_explanation": "Verhalten tritt regelmäßig auf."},
                {"score": 5, "text": "Täglich", "option_explanation": "Verhalten tritt sehr häufig auf."}
            ]
        },
        {
